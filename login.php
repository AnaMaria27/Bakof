      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block bg-img source='img/images.jpg'"></"></div>
              <div class="col-lg-6">
                <div class="p-5">
				  ...
				  <form method="POST" class="user">
                    <div class="form-group">
                      <input type="text" name="cpf" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="CPF">
                    </div>
                    <div class="form-group">
